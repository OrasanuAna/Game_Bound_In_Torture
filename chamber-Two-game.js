...
const dialogues = [
  {
    speaker: "Aldric",
    text: "Shadows… a past I don’t understand. What was your connection to the inferno?",
  },
  {
    speaker: "Vespera",
    text: "It wasn’t my choice. Behind my smile, a force you never understood. Now, it’s too late.",
  },
  {
    speaker: "Aldric",
    text: "This room, this smell… what is all of this? Regrets… embedded in flesh and blood. A corpse… there's a corpse here, isn’t there?",
  },
  {
    speaker: "Vespera",
    text: "There are no memories here, Aldric. Only echoes. Flesh and blood consumed it all.",
  },
];
...
function goToNextLevel() {
  ...
  if (currentLevel.includes("chamber-Two")) {
    window.location.href = "chamber-Three.html"; // Move to Chamber Three
  }
}
...
app.ticker.add(() => {
  ...
  [ground, platform1, platform2, platform3, platform4, movingPlatform].forEach(
