...
function goToNextLevel() {
    if (!transitioning) {
        ...
        setTimeout(() => {
            window.location.href = "/chamber-One/chamber-One.html"; // Move to the next level
        }, 2000);
    }
}
...
app.ticker.add(() => {
    if (!movementPaused) {
        ...
        if (secretObjectExists && isColliding(player, secretObject)) {
            ...
            document.querySelectorAll(".inventory-slot")[0].innerHTML = `<img src="/assets/artefact1.png" alt="Letter">`;
        }
